    ...
    <div class="mianc" id="mianc">
        ...
        <div class="ck-slide">
            <ul class="ck-slide-wrapper">
                <li>
                    <a href="javascript:"><img src="pages/gitqian/images/datu_02.jpg" alt=""></a>
                </li>
                <li style="display:none">
                    <a href="javascript:"><img src="pages/gitqian/images/datu_1_03.jpg" alt=""></a>
                </li>
                <li style="display:none">
                    <a href="javascript:"><img src="pages/gitqian/images/datu_02.jpg" alt=""></a>
                </li>
        ...
        <div class="xiangmu_nr" id="demoo">
            <div id="indemo">
                <div id="demoo1">
                    <ul>
                        <li class="xiangmu_1">
                            <a href="#"><img src="pages/gitqian/images/xiangmu_03.jpg"></a>
                            <a href="#"><h4>达博圆</h4></a><span>电力职工医院项目外观，项目外观。</span>
                        </li>
                        <li class="xiangmu_1">
                            <a href="#"><img src="pages/gitqian/images/xiangmu_05.jpg"></a>
                            <a href="#"><h4>达博圆</h4></a><span>电力职工医院项目外观，项目外观。</span>
                        </li>
                        <li class="xiangmu_1">
                            <a href="#"><img src="pages/gitqian/images/xiangmu_07.jpg"></a>
                            <a href="#"><h4>达博圆</h4></a><span>电力职工医院项目外观，项目外观。</span>
                        </li>
                        <li class="xiangmu_1">
                            <a href="#"><img src="pages/gitqian/images/xiangmu_03.jpg"></a>
...
<div class="guanyvwm">
    <div class="nr_bufen_1_jz">
        ...
        <div class="women_1">
            <div class="zuo_s">
                <p>公司简介</p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;贵州国贸物业管理有限公司（原贵阳国贸物业管理中心，于2014年8月25日正式更名）始建于1998年，注册资金300万，属于二级物业管理注册资质的集体企业，是目前贵阳市物业管理行业实力较强的物业公司之一，第三个道小区及市政项目。<a href="#">[详情]</a></span>
            </div>
            <div class="women_1_a">
                <a href="about.html"><img src="pages/gitqian/images/guanyv_03.jpg"></a>
            </div>
        </div>
        <div class="women_2">
            <div class="zuo_s">
                ...
                <span>
					<ul class="liebiao">
						<li><img src="pages/gitqian/images/dian_03.png">质量方针：科学管理、优质服务、文明环境、顾客满意、持续发展.</li>
						<li><img src="pages/gitqian/images/dian_03.png">企业精神：开拓、求实、创新.</li>
						<li><img src="pages/gitqian/images/dian_03.png">服务宗旨：宾客至上，服务第一.</li>
					</ul>
				</span>
            </div>
            <div class="women_1_a">
                <a href="#"><img src="pages/gitqian/images/guanyv_05.jpg"></a>
            </div>
        </div>
        <div class="women_1">
            <div class="zuo_s">
                ...
                <span>
					<ul class="liebiao">
						<li><img src="pages/gitqian/images/dian_03.png">2016年国家计委、建委批示在贵州..</li>
						<li><img src="pages/gitqian/images/dian_03.png">2015年组赴绵开始筹建工作..</li>
						<li><img src="pages/gitqian/images/dian_03.png">2014完成了由仿制到试制改进的任.</li>
						<li><img src="pages/gitqian/images/dian_03.png">2013年工厂经国家正式验收合格..</li>
						<li><img src="pages/gitqian/images/dian_03.png">2012年工业学大庆”先进企业...</li>
						<li><a href="#">更多>></a></li>
					</ul>
				</span>
            </div>
            <div class="women_1_a">
                <a href="#"><img src="pages/gitqian/images/guanyv_09.jpg"></a>
            </div>
        </div>
        <div class="women_2">
            <div class="zuo_s">
                <p>领导致辞</p>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;匆忙中，就要与2015年挥手作别。在这辞旧迎新之际，我很高兴能代表贵阳国贸物业管理中心向在各个岗位上辛勤工作的广大员，工致以节日的问候，祝大家在新的一年里工作顺利，心想事成！</span>
            </div>
            <div class="women_1_a">
                <a href="#"><img src="pages/gitqian/images/guanyv_10.jpg"></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="xinwen_jz">
        ...
        <div id="cen_right_top">
            ...
            <ul style="display:block">
                <div class="news">
                    <div class="xinwen_tu">
                        <a class=xinwen_img href="#"><img src="pages/gitqian/images/xw_03.jpg"></a>
                        <dl class="xinwen_wz">
            ...
            <ul>
                <div class="news">
                    <div class="xinwen_tu">
                        <a class=xinwen_img href="#"><img src="pages/gitqian/images/xiangmu_07.jpg"></a>
                        <dl class="xinwen_wz">
                            <dt><a href="#">公司质量体系内审员安全巡查</a><span>2016-10-10</span></dt>
                            <dd>为帮助各获证企业掌握体系认证标准要求，使企业的管理体...</dd>
                        </dl>
            ...
            <ul>
                <div class="news">
                    <div class="xinwen_tu">
                        <a class=xinwen_img href="#"><img src="pages/gitqian/images/xiangmu_05.jpg"></a>
                        <dl class="xinwen_wz">
        ...
        <div class="gonggao">
            ...
            <ul class="gonggao_lb">
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">物业管理风险与危机防范</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">贵州省物业管理协</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">贵阳市物业管理协会2015年</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">为了行业的尊严</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">中国物业管理协会第四次会员代表</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">物业管理风险与危机防范</a></li>
                <li><img src="pages/gitqian/images/tb_03.png"><a href="#">《物业管理行业发展报告》正式发行</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="dibu_1">
    <p>版权所有 贵州国贸物业管理有限公司 黔ICP备10001741号<br>
        技术支持：WangID 驰通网络</p>
</div>
