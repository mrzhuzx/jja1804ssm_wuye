        ...
        <div class="gsjj_nr">
            ...
            <ul>
                ...
                <div style="margin:10px 0px;" >
                    家人姓名：<input type="text"  name="ofname" value="队长" />
                </div><div style="margin:10px 0px;">
                    家人性别：<input type="text" name="ofsex" value="男"/>
                </div><div style="margin:10px 0px;">
                    家人籍贯：<input type="text"  name="ofhomeplace" value="中国人民共和国" />
                </div><div style="margin:10px 0px;">
                    家人电话：<input type="text"  name="oftel" value="12580"/>
                </div><div style="margin:10px 0px;">
                    与业主关系：<input type="text"  name="ofnexus" value="父子"/>
                </div>
                </li>
                <hr>
                <button type="submit">增加<span style="width:20px;"></span>家人</button>
                </li>
            </ul>
            </form>
        </div>
