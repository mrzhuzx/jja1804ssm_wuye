	...
	<div class="zynr_db" style="height: 1000px;">
		...
		<div class="gsjj_nr">
			...
			<ul class="xwlb_bj">
				...
				<li>
					...
					<dl>
						...
						<span>投诉人电话：${re.cphone}</span><br>
						<span>受理人：${re.rname}</span><br>
						<span>投诉时间：<fmt:formatDate value='${re.cdate}' pattern='yyyy-MM-dd'/></span><br>
			...
			<div class="webdiyerCss">
				<a href="${pageContext.request.contextPath}/complain/fenye.do?pageNum=1"  style="margin-right:5px;">首页</a>
				<a href="${pageContext.request.contextPath}/complain/fenye.do?pageNum=${pageNum-1}"  style="margin-right:5px;">上一页</a>
				<a href="${pageContext.request.contextPath}/complain/fenye.do?pageNum=${pageNum+1}" style="margin-right:5px;">下一页</a>
				<a href="${pageContext.request.contextPath}/complain/fenye.do?pageNum=${pageAll}" style="margin-right:5px;">尾页</a>
			</div>
		</div>
