...
<div class="zy_gywm">
    ...
    <div class="zynr_db" style="height: 1000px;">
        ...
        <!--内容-->
        <div class="gsjj_nr">
            <form method="post" action="ower/xgof.do?olid=${ower.olid}&&ofid=${ofowerFamil.ofid}">
            <ul>
                <li>
                <div style="margin:10px 0px;" >
                    成员姓名：<input type="text"  name="ofname" value="${ofowerFamil.ofname}" />
                </div><div style="margin:10px 0px;">
                    成员性别：<input type="text" name="ofsex" value="${ofowerFamil.ofsex}"/>
                </div><div style="margin:10px 0px;">
                    成员籍贯：<input type="text"  name="ofhomeplace" value="${ofowerFamil.ofhomeplace}" />
                </div><div style="margin:10px 0px;">
                    成员电话：<input type="text"  name="oftel" value="${ofowerFamil.oftel}"/>
                </div><div style="margin:10px 0px;">
                    与业主关系：<input type="text"  name="ofnexus" value="${ofowerFamil.ofnexus}"/>
                </div>
                </li>
                <hr>
                <button type="submit">修改<span style="width:20px;"></span>成员</button>
                </li>
            </ul>
            </form>
        </div>
