...
<div class="zy_gywm">
	<div class="ejdh" style="height: 1050px;">
		...
		<div class="zy_dh_lb">
			<ul>
				<li id="women"><img src="${pageContext.request.contextPath}/pages/gitqian/images/zy1_08.png"><a id="wenzidangq" href="${pageContext.request.contextPath}/pages/gitqian/repairsave.jsp">进入设备报修</a></li>
			</ul>
		</div>
	</div>
		...
		<div class="gsjj_nr">
			...
			<ul class="xwlb_bj">
				...
				<li>
					...
					<dl>
						<span>业主：${re.repairname}</span><br>
						<span>业主电话：${re.repairphone}</span><br>
						<span>报修描述：${re.repdesc}</span><br>
						<%--<span>报修日期：<fmt:formatDate value='${re.reportdate}' pattern='yyyy-MM-dd'/></span><br>--%>
						<%--<span>维修日期：<fmt:formatDate value='${re.repairdate}' pattern='yyyy-MM-dd'/></span><br>--%>
						<%--<span>维修人：${re.principal}</span><br>--%>
						<%--&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/recruit/qianreone.do?recruitid=${re.recruitid}">...添加</a>--%>
					</dl>
			...
			<div class="webdiyerCss">
				<a href="${pageContext.request.contextPath}/repair/fenye.do?pageNum=1"  style="margin-right:5px;">首页</a>
				<a href="${pageContext.request.contextPath}/repair/fenye.do?pageNum=${pageNum-1}"  style="margin-right:5px;">上一页</a>
				<a href="${pageContext.request.contextPath}/repair/fenye.do?pageNum=${pageNum+1}" style="margin-right:5px;">下一页</a>
				<a href="${pageContext.request.contextPath}/repair/fenye.do?pageNum=${pageAll}" style="margin-right:5px;">尾页</a>
			</div>
		</div>
	...
	<%--<ul class="xwlb_bj">--%>
		<%--<c:forEach var="re" items="${recruitList}">--%>
			<%--<li>--%>
				<%--<h1><img src="${pageContext.request.contextPath}/pages/gitqian/images/guanyv_05.jpg"></h1>--%>
				<%--<dl>--%>
					<%--<span>投诉摘要：${re.title}</span><br>--%>
					<%--<span>投诉描述：${re.descr}</span><br>--%>
					<%--<span>投诉人姓名：${re.cname}</span><br>--%>
					<%--&lt;%&ndash;<span>投诉人电话：${re.cphone}</span><br>&ndash;%&gt;--%>
					<%--&lt;%&ndash;<span>受理人：${re.rname}</span><br>&ndash;%&gt;--%>
					<%--&lt;%&ndash;<span>截止时间：<fmt:formatDate value='${re.recruitend}' pattern='yyyy-MM-dd'/></span><br>&ndash;%&gt;--%>
					<%--&lt;%&ndash;<span>地址：${re.address}&nbsp;|&nbsp;联系方式：${re.recruitnumber}</span>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath}/recruit/qianreone.do?recruitid=${re.recruitid}">...详情</a>&ndash;%&gt;--%>
				<%--</dl>--%>
			<%--</li>--%>
		<%--</c:forEach>--%>
