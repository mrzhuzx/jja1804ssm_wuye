...
<div class="zy_gywm">
    <div class="ejdh" style="height: 1050px;">
        ...
        <div class="zy_dh_lb">
            <ul>
                <li><img src="${pageContext.request.contextPath}/pages/gitqian/images/zy1_08_z.png"><a href="ohtc/qtcxhstate.do?pageNum=1">房屋出售</a></li>
                <li id="women"><img src="${pageContext.request.contextPath}/pages/gitqian/images/zy1_08.png"><a id="wenzidangq" href="ohtc/qtcxloan.do?pageNum=1">房屋出租</a></li>
                </ul>
        </div>
    </div>
    ...
    <div class="zynr_db" style="height: 1000px;">
        ...
        <div class="gsjj_nr">
            ...
            <div class="webdiyerCss">
                ...
                <a href="ohtc/qtcxloan.do?pageNum=${pageNum+1}" style="margin-right:5px;">下一页</a>
                <a href="ohtc/qtcxloan.do?pageNum=${pageAll}" style="margin-right:5px;">尾页</a>
            </div>
        </div>
    </div>
</div>
