	...
	<div class="zynr_db" style="height: 1000px;">
		...
		<div class="gsjj_nr">
			...
			<ul class="xwlb_bj">
				...
				<form action="${pageContext.request.contextPath}/complain/savec.do" method="post">
...
<tr>
					<div  >
						...
						<th><input &nbsp&nbsp class="form-control" placeholder="title"  value="" name="title" ></th>
					</div>
</tr>
<tr>
					<div>
						<th><label>问题描述</label></th>
						<th><input class="form-control" placeholder="descr" value="" name="descr"></th>
					</div>
</tr>
	<tr>
					<div>
						<th><label>业主</label></th>
						<th><input class="form-control" placeholder="cname" value="" name="cname"></th>
					</div>
	</tr>
	<tr>
					<div>
						<th><label>业主电话</label></th>
						<th><input class="form-control" placeholder="cname" value="" name="cphone"></th>
					</div>
	...
	<tr>
		...
		<div>
			<th><label>上报日期</label></th>
			<th><input class="form-control" placeholder="cdate" id="dateid" value="" name="cdate"></th>
		</div>
	</tr>
</table>
