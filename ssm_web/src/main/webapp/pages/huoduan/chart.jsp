...
<body>
<a href="${pageContext.request.contextPath}/pages/houduan/assets/css/bootstrap.css">${pageContext.request.contextPath}/pages/houduan/assets/css/bootstrap.css<a/>
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="chart.html" class="active-menu"><i class="fa fa-bar-chart-o"></i>数据表</a>
                </li>
                <li>
                ...
                <li>
                    <a href="#"><i class="fa fa-sitemap"></i>下拉菜单<span class="fa arrow"></span></a>
