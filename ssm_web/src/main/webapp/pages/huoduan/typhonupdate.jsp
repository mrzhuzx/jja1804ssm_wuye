                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="${pageContext.request.contextPath}/type/modify.do" method="post">


                                        <div  >
                                            <label>物资类别名称ID</label>
                                            <input class="form-control" placeholder="" value="${tbMatter_sort.mattersortid}" name="mattersortid">
                                        </div>
                                        <div  >
                                            <label>物资类别名称</label>
                                            <input class="form-control" placeholder="" value="${tbMatter_sort.mattersort}" name="mattersort" >
                                        </div>
