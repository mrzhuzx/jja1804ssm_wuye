                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form action="${pageContext.request.contextPath}/house/updethouse.do?hid=${myhouse.hid}" method="post">

                                        <div >
                                            <label>房屋编号</label>
                                            <input class="form-control" placeholder="房屋编号"  name="hnumber" value="${myhouse.hnumber}">
                                        </div>
                                        <div>
                                            <label>楼宇名称</label>
                                            <input class="form-control" placeholder="楼宇名称" name="hbulidingname" value="${myhouse.hbulidingname}">
                                        </div>
                                       <div >
                                           <label>楼宇编号</label>
                                           <input class="form-control" placeholder="楼宇编号" name="hunitnumber" value="${myhouse.hunitnumber}">
                                        </div>
                                        <div >
                                            <label>房屋楼层</label>
                                            <input class="form-control"  placeholder="房屋楼层" name="hfloor"  value="${myhouse.hfloor}">
                                        </div>
                                        <div >
                                            <label>房屋朝向</label>
                                            <input class="form-control" placeholder="房屋朝向" name="hdirection"  value="${myhouse.hdirection}">
                                        </div>
                                        <div >
                                            <label>房屋面积</label>
                                            <input class="form-control" placeholder="房屋面积" name="harea" value="${myhouse.harea}">
                                        </div>
                                        <div >
                                            <label>房屋描述</label>
                                        ...
                                        <br>
                                            <div>
                                            <button type="submit" class="btn btn-success"><i class="fa fa-save "></i> 确定修改</button>
