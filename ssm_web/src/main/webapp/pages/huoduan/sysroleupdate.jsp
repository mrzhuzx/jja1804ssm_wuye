                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="${pageContext.request.contextPath}/role/roleupdate.do?" method="post">
                                        <div>
                                            <label>职位ID</label>
                                            <input class="form-control" placeholder="" value="${role.roleid}" name="roleid" readonly="readonly" >
                                        </div>

                                        <div>
                                            <label>职位名称</label>
                                            <input class="form-control" placeholder="" value="${role.rolename}" name="rolename" >
                                        </div>
                                        <div>
                                            <label>职位状态</label>
                                            <input class="form-control" placeholder="" value="${role.rolestatus}" name="rolestatus" >
                                        </div>
