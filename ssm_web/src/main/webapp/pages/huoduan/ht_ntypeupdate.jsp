                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="${pageContext.request.contextPath}/nt/htnewstypeupda.do?ntid=${newsType.ntid}" method="post">
                                        <%--<input  type="hidden" class="form-control" placeholder="电表编号" value="${electrics.electricid}" name="electricid"  >--%>


                                        <div >
                                            <label>类型ID</label>
                                            <input class="form-control" placeholder="类型ID" readonly value="${newsType.ntid}">
                                        </div>


                                        <div>
                                            <label>类型名字</label>
                                            <input class="form-control" placeholder="类型名字" name="ntypename" value="${newsType.ntypename}">
                                        </div>
