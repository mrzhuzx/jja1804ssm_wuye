                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="${pageContext.request.contextPath}/role/rolesave.do?" method="post">
                                        <%--<input  type="hidden" class="form-control" placeholder="电表编号" value="${electrics.electricid}" name="electricid"  >--%>

                                        <div>
                                            <label>职位名称</label>
                                            <input class="form-control" placeholder="职位名称" value="客服" name="rolename" >
                                        </div>
                                            <div>
                                                <label>职位状态</label>
                                                <input class="form-control" placeholder="职位状态" value="工作中" name="rolestatus" >
                                            </div>
