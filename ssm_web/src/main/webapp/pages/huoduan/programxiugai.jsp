...
<div id="page-wrapper" >
    <div id="page-inner">
        ...
        <div class="col-lg-6">
            <form action="${pageContext.request.contextPath}/pr/xiangmuupdate.do" method="post">
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">ID</label>
                        <input type="text" class="form-control" id="inputSuccess" value="${prg.pid}" name="pid"></h4>
                </div>
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">物业项目名字</label>
                        <input type="text" class="form-control" id="" value="${prg.pname}" name="pname"></h4>
                </div>
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">图片信息</label>
                        <input type="text" class="form-control" id="inputError" value="${prg.ppicture}" name="ppicture"></h4>

                </div>
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">描述</label>
                        <input type="text" class="form-control" id="easypiechart-orange" value="${prg.pintroduce}" name="pintroduce"></h4>
                </div>
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">项目所在地</label>
                        <input type="text" class="form-control" id="easypiechart-red" value="${prg.padress}" name="padress"></h4>
                </div>
                <div class="form-group has-success">
                    <h4><label class="control-label" for="inputSuccess">项目类型</label>
                        <select class="form-control" placeholder="" name="ptid">
                            <option value="${prg.ptid}">${prg.ptypename}</option>
