                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <form action="${pageContext.request.contextPath}/tbch/tbChargeUpdate.do?id=${tbCharges.chargeid}&name=${tbCharges.chargename}" method="post">
                                        <div >
                                            <label>收费项</label>
                                            <input class="form-control" disabled   value="${tbCharges.chargename}">
                                        </div>
                                        <div >
                                            <label>收费值</label>
                                            <input class="form-control"  name="charge" value="${tbCharges.chargestandard}">
                                        </div>
                                        <br>
                                            <div>
