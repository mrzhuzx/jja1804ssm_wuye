...
import com.ssm.wuye.domain.RepairInfoExample.Criteria;
import com.ssm.wuye.domain.RepairInfoExample.Criterion;
import com.ssm.wuye.domain.RepairInfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class RepairInfoSqlProvider {

    public String countByExample(RepairInfoExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(RepairInfoExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(RepairInfo record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(RepairInfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RepairInfo record = (RepairInfo) parameter.get("record");
        RepairInfoExample example = (RepairInfoExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(RepairInfo record) {
        SQL sql = new SQL();
        sql.UPDATE("repair_info");
    ...
    protected void applyWhere(SQL sql, RepairInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
