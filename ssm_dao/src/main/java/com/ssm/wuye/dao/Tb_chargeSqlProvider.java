...
import com.ssm.wuye.domain.Tb_chargeExample.Criteria;
import com.ssm.wuye.domain.Tb_chargeExample.Criterion;
import com.ssm.wuye.domain.Tb_chargeExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Tb_chargeSqlProvider {

    public String countByExample(Tb_chargeExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Tb_chargeExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Tb_charge record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Tb_chargeExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Tb_charge record = (Tb_charge) parameter.get("record");
        Tb_chargeExample example = (Tb_chargeExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Tb_charge record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_charge");
    ...
    protected void applyWhere(SQL sql, Tb_chargeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
