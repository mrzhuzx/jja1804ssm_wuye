...
import com.ssm.wuye.domain.ContractTypeExample.Criteria;
import com.ssm.wuye.domain.ContractTypeExample.Criterion;
import com.ssm.wuye.domain.ContractTypeExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ContractTypeSqlProvider {

    public String countByExample(ContractTypeExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ContractTypeExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(ContractType record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ContractTypeExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ContractType record = (ContractType) parameter.get("record");
        ContractTypeExample example = (ContractTypeExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ContractType record) {
        SQL sql = new SQL();
        sql.UPDATE("contract_type");
    ...
    protected void applyWhere(SQL sql, ContractTypeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
