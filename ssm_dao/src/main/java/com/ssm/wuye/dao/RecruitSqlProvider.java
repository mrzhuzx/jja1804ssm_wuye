...
public class RecruitSqlProvider {
    ...
    public String insertSelective(Recruit record) {
        ...
        if (record.getContactnumber() != null) {
            sql.VALUES("contactNumber", "#{contactnumber,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getContactnumber() != null) {
            sql.SET("contactNumber = #{record.contactnumber,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Recruit record) {
        ...
        if (record.getContactnumber() != null) {
            sql.SET("contactNumber = #{contactnumber,jdbcType=VARCHAR}");
        }
