...
import com.ssm.wuye.domain.GasmeterExample.Criteria;
import com.ssm.wuye.domain.GasmeterExample.Criterion;
import com.ssm.wuye.domain.GasmeterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class GasmeterSqlProvider {

    public String countByExample(GasmeterExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("gasmeter");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(GasmeterExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("gasmeter");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Gasmeter record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("gasmeter");
    ...
    public String selectByExample(GasmeterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Gasmeter record = (Gasmeter) parameter.get("record");
        GasmeterExample example = (GasmeterExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Gasmeter record) {
        SQL sql = new SQL();
        sql.UPDATE("gasmeter");
    ...
    protected void applyWhere(SQL sql, GasmeterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
