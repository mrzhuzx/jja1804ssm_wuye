...
import com.ssm.wuye.domain.RepairinformationExample.Criteria;
import com.ssm.wuye.domain.RepairinformationExample.Criterion;
import com.ssm.wuye.domain.RepairinformationExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class RepairinformationSqlProvider {

    public String countByExample(RepairinformationExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("repair_information");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(RepairinformationExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("repair_information");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Repairinformation record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("repair_information");
    ...
    public String selectByExample(RepairinformationExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Repairinformation record = (Repairinformation) parameter.get("record");
        RepairinformationExample example = (RepairinformationExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("repair_information");
    ...
    public String updateByPrimaryKeySelective(Repairinformation record) {
        SQL sql = new SQL();
        sql.UPDATE("repair_information");
    ...
    protected void applyWhere(SQL sql, RepairinformationExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
