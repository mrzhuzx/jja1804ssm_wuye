...
import com.ssm.wuye.domain.SysOwerFamilyExample.Criteria;
import com.ssm.wuye.domain.SysOwerFamilyExample.Criterion;
import com.ssm.wuye.domain.SysOwerFamilyExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SysOwerFamilySqlProvider {

    public String countByExample(SysOwerFamilyExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(SysOwerFamilyExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(SysOwerFamily record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(SysOwerFamilyExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysOwerFamily record = (SysOwerFamily) parameter.get("record");
        SysOwerFamilyExample example = (SysOwerFamilyExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(SysOwerFamily record) {
        SQL sql = new SQL();
        sql.UPDATE("sys_ower_family");
    ...
    protected void applyWhere(SQL sql, SysOwerFamilyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
