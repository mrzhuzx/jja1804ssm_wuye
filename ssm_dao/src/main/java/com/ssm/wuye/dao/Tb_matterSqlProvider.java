...
import com.ssm.wuye.domain.Tb_matterExample.Criteria;
import com.ssm.wuye.domain.Tb_matterExample.Criterion;
import com.ssm.wuye.domain.Tb_matterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Tb_matterSqlProvider {

    public String countByExample(Tb_matterExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Tb_matterExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Tb_matter record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Tb_matterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Tb_matter record = (Tb_matter) parameter.get("record");
        Tb_matterExample example = (Tb_matterExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Tb_matter record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_matter");
    ...
    protected void applyWhere(SQL sql, Tb_matterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
