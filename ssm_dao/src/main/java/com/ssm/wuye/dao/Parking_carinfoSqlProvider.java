...
import com.ssm.wuye.domain.Parking_carinfoExample.Criteria;
import com.ssm.wuye.domain.Parking_carinfoExample.Criterion;
import com.ssm.wuye.domain.Parking_carinfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Parking_carinfoSqlProvider {

    public String countByExample(Parking_carinfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("parking_carinfo");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(Parking_carinfoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("parking_carinfo");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Parking_carinfo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("parking_carinfo");
    ...
    public String selectByExample(Parking_carinfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Parking_carinfo record = (Parking_carinfo) parameter.get("record");
        Parking_carinfoExample example = (Parking_carinfoExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("parking_carinfo");
    ...
    public String updateByPrimaryKeySelective(Parking_carinfo record) {
        SQL sql = new SQL();
        sql.UPDATE("parking_carinfo");
    ...
    protected void applyWhere(SQL sql, Parking_carinfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
