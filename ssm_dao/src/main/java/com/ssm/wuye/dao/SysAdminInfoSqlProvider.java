...
import com.ssm.wuye.domain.SysAdminInfoExample.Criteria;
import com.ssm.wuye.domain.SysAdminInfoExample.Criterion;
import com.ssm.wuye.domain.SysAdminInfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class SysAdminInfoSqlProvider {

    public String countByExample(SysAdminInfoExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(SysAdminInfoExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(SysAdminInfo record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(SysAdminInfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SysAdminInfo record = (SysAdminInfo) parameter.get("record");
        SysAdminInfoExample example = (SysAdminInfoExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(SysAdminInfo record) {
        SQL sql = new SQL();
        sql.UPDATE("sys_admin_info");
    ...
    protected void applyWhere(SQL sql, SysAdminInfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
