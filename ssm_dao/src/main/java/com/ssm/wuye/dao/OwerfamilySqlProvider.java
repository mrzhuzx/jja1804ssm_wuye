...
import com.ssm.wuye.domain.OwerfamilyExample.Criteria;
import com.ssm.wuye.domain.OwerfamilyExample.Criterion;
import com.ssm.wuye.domain.OwerfamilyExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class OwerfamilySqlProvider {

    public String countByExample(OwerfamilyExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("owerfamily");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(OwerfamilyExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("owerfamily");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Owerfamily record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("owerfamily");
    ...
    public String selectByExample(OwerfamilyExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Owerfamily record = (Owerfamily) parameter.get("record");
        OwerfamilyExample example = (OwerfamilyExample) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("owerfamily");
    ...
    public String updateByPrimaryKeySelective(Owerfamily record) {
        SQL sql = new SQL();
        sql.UPDATE("owerfamily");
    ...
    protected void applyWhere(SQL sql, OwerfamilyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
