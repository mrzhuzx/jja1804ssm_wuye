...
import com.ssm.wuye.domain.ParkingCarinfoExample.Criteria;
import com.ssm.wuye.domain.ParkingCarinfoExample.Criterion;
import com.ssm.wuye.domain.ParkingCarinfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ParkingCarinfoSqlProvider {

    public String countByExample(ParkingCarinfoExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ParkingCarinfoExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(ParkingCarinfo record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ParkingCarinfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ParkingCarinfo record = (ParkingCarinfo) parameter.get("record");
        ParkingCarinfoExample example = (ParkingCarinfoExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ParkingCarinfo record) {
        SQL sql = new SQL();
        sql.UPDATE("parking_carinfo");
    ...
    protected void applyWhere(SQL sql, ParkingCarinfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
