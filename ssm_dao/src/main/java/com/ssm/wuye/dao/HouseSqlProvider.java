...
import com.ssm.wuye.domain.HouseExample.Criteria;
import com.ssm.wuye.domain.HouseExample.Criterion;
...
public class HouseSqlProvider {
    ...
    public String insertSelective(House record) {
        ...
        if (record.getFloorage() != null) {
            sql.VALUES("floorage", "#{floorage,jdbcType=INTEGER}");
        }
        ...
        if (record.getStreetId() != null) {
            sql.VALUES("street_id", "#{streetId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getPubdate() != null) {
            sql.SET("pubdate = #{record.pubdate,jdbcType=DATE}");
        }
        
        if (record.getFloorage() != null) {
            sql.SET("floorage = #{record.floorage,jdbcType=INTEGER}");
        }
        ...
        if (record.getStreetId() != null) {
            sql.SET("street_id = #{record.streetId,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, HouseExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
