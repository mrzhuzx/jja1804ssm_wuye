...
import com.ssm.wuye.domain.Parking_placeinfoExample.Criteria;
import com.ssm.wuye.domain.Parking_placeinfoExample.Criterion;
import com.ssm.wuye.domain.Parking_placeinfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Parking_placeinfoSqlProvider {

    public String countByExample(Parking_placeinfoExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Parking_placeinfoExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Parking_placeinfo record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Parking_placeinfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Parking_placeinfo record = (Parking_placeinfo) parameter.get("record");
        Parking_placeinfoExample example = (Parking_placeinfoExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Parking_placeinfo record) {
        SQL sql = new SQL();
        sql.UPDATE("parking_placeinfo");
    ...
    protected void applyWhere(SQL sql, Parking_placeinfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
