...
import com.ssm.wuye.domain.ProgramExample.Criteria;
import com.ssm.wuye.domain.ProgramExample.Criterion;
...
public class ProgramSqlProvider {
    ...
    public String updateByPrimaryKeySelective(Program record) {
        ...
        if (record.getPpicture() != null) {
            sql.SET("ppicture = #{ppicture,jdbcType=VARCHAR}");
        }
        
        if (record.getPintroduce() != null) {
            sql.SET("pintroduce = #{pintroduce,jdbcType=VARCHAR}");
        }
        
        if (record.getPadress() != null) {
            sql.SET("padress = #{padress,jdbcType=VARCHAR}");
        }
        
        if (record.getPtid() != null) {
            sql.SET("ptid = #{ptid,jdbcType=INTEGER}");
        }
    ...
    protected void applyWhere(SQL sql, ProgramExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
