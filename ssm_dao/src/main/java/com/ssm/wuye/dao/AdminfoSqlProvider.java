...
import com.ssm.wuye.domain.AdminfoExample.Criteria;
import com.ssm.wuye.domain.AdminfoExample.Criterion;
import com.ssm.wuye.domain.AdminfoExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class AdminfoSqlProvider {

    public String countByExample(AdminfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("adminfo");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String deleteByExample(AdminfoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("adminfo");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Adminfo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("adminfo");
    ...
    public String selectByExample(AdminfoExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Adminfo record = (Adminfo) parameter.get("record");
        AdminfoExample example = (AdminfoExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Adminfo record) {
        SQL sql = new SQL();
        sql.UPDATE("adminfo");
    ...
    protected void applyWhere(SQL sql, AdminfoExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
