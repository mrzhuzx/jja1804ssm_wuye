...
import com.ssm.wuye.domain.Sys_owerExample.Criteria;
import com.ssm.wuye.domain.Sys_owerExample.Criterion;
import com.ssm.wuye.domain.Sys_owerExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Sys_owerSqlProvider {

    public String countByExample(Sys_owerExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Sys_owerExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Sys_ower record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Sys_owerExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Sys_ower record = (Sys_ower) parameter.get("record");
        Sys_owerExample example = (Sys_owerExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Sys_ower record) {
        SQL sql = new SQL();
        sql.UPDATE("sys_ower");
    ...
    protected void applyWhere(SQL sql, Sys_owerExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
