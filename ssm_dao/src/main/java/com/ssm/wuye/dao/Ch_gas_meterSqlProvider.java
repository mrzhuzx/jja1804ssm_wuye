...
import com.ssm.wuye.domain.Ch_gas_meterExample.Criteria;
import com.ssm.wuye.domain.Ch_gas_meterExample.Criterion;
import com.ssm.wuye.domain.Ch_gas_meterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Ch_gas_meterSqlProvider {

    public String countByExample(Ch_gas_meterExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Ch_gas_meterExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Ch_gas_meter record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Ch_gas_meterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Ch_gas_meter record = (Ch_gas_meter) parameter.get("record");
        Ch_gas_meterExample example = (Ch_gas_meterExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Ch_gas_meter record) {
        SQL sql = new SQL();
        sql.UPDATE("ch_gas_meter");
    ...
    protected void applyWhere(SQL sql, Ch_gas_meterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
