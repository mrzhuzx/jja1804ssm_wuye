...
import com.ssm.wuye.domain.Ch_water_meterExample.Criteria;
import com.ssm.wuye.domain.Ch_water_meterExample.Criterion;
import com.ssm.wuye.domain.Ch_water_meterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Ch_water_meterSqlProvider {

    public String countByExample(Ch_water_meterExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Ch_water_meterExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Ch_water_meter record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Ch_water_meterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Ch_water_meter record = (Ch_water_meter) parameter.get("record");
        Ch_water_meterExample example = (Ch_water_meterExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Ch_water_meter record) {
        SQL sql = new SQL();
        sql.UPDATE("ch_water_meter");
    ...
    protected void applyWhere(SQL sql, Ch_water_meterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
