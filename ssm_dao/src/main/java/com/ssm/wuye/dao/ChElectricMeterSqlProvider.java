...
import com.ssm.wuye.domain.ChElectricMeterExample.Criteria;
import com.ssm.wuye.domain.ChElectricMeterExample.Criterion;
import com.ssm.wuye.domain.ChElectricMeterExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class ChElectricMeterSqlProvider {

    public String countByExample(ChElectricMeterExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(ChElectricMeterExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(ChElectricMeter record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(ChElectricMeterExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ChElectricMeter record = (ChElectricMeter) parameter.get("record");
        ChElectricMeterExample example = (ChElectricMeterExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ChElectricMeter record) {
        SQL sql = new SQL();
        sql.UPDATE("ch_electric_meter");
    ...
    protected void applyWhere(SQL sql, ChElectricMeterExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
