...
import com.ssm.wuye.domain.Tb_payExample.Criteria;
import com.ssm.wuye.domain.Tb_payExample.Criterion;
import com.ssm.wuye.domain.Tb_payExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Tb_paySqlProvider {

    public String countByExample(Tb_payExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Tb_payExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Tb_pay record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Tb_payExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Tb_pay record = (Tb_pay) parameter.get("record");
        Tb_payExample example = (Tb_payExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Tb_pay record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_pay");
    ...
    protected void applyWhere(SQL sql, Tb_payExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
