...
import com.ssm.wuye.domain.Tb_matter_sortExample.Criteria;
import com.ssm.wuye.domain.Tb_matter_sortExample.Criterion;
import com.ssm.wuye.domain.Tb_matter_sortExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class Tb_matter_sortSqlProvider {

    public String countByExample(Tb_matter_sortExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(Tb_matter_sortExample example) {
        SQL sql = new SQL();
    ...
    public String insertSelective(Tb_matter_sort record) {
        SQL sql = new SQL();
    ...
    public String selectByExample(Tb_matter_sortExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Tb_matter_sort record = (Tb_matter_sort) parameter.get("record");
        Tb_matter_sortExample example = (Tb_matter_sortExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Tb_matter_sort record) {
        SQL sql = new SQL();
        sql.UPDATE("tb_matter_sort");
    ...
    protected void applyWhere(SQL sql, Tb_matter_sortExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
